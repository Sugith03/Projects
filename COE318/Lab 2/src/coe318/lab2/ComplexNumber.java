...
//Initialize the instance variables
    ...
    public ComplexNumber divide(ComplexNumber z) {
        return new ComplexNumber ((this.real*z.real+this.imaginary*z.imaginary)/(z.real*z.real+z.imaginary*z.imaginary),(this.imaginary*z.real-this.real*z.imaginary)/(z.real*z.real+z.imaginary*z.imaginary));	//A stub: to be fixed
    }
